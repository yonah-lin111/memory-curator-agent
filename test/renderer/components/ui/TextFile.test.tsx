...
describe("TextFile Component", () => {
  ...
  it("renders file name, size, and icon", () => {
    render(
      <TextFile url="mc-img://chat-text/test-file.txt" fileName="readme.md" sizeBytes={2048} />,
    )
  ...
  it("formats bytes correctly", () => {
    render(<TextFile url="mc-img://chat-text/a.txt" fileName="a.txt" sizeBytes={500} />)

    expect(screen.getByText("500 B")).toBeInTheDocument()

    cleanup()

    render(<TextFile url="mc-img://chat-text/b.txt" fileName="b.txt" sizeBytes={1536000} />)

    expect(screen.getByText("1.5 MB")).toBeInTheDocument()
  })

  it("opens preview modal on click and displays text content", async () => {
    render(<TextFile url="mc-img://chat-text/test.txt" fileName="test.txt" sizeBytes={100} />)
  ...
  it("shows error state when fetch fails", async () => {
    ...
    render(<TextFile url="mc-img://chat-text/bad.txt" fileName="bad.txt" sizeBytes={100} />)
  ...
  it("previews markdown file directly without wrapping in code blocks", async () => {
    ...
    render(<TextFile url="mc-img://chat-text/test.md" fileName="test.md" sizeBytes={100} />)
  ...
  it("previews typescript file with typescript code blocks", async () => {
    ...
    render(<TextFile url="mc-img://chat-text/test.ts" fileName="test.ts" sizeBytes={100} />)
  ...
  it("handles backticks correctly in file content", async () => {
    ...
    render(<TextFile url="mc-img://chat-text/test.js" fileName="test.js" sizeBytes={100} />)
