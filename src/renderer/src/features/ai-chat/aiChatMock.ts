    ...
    messages: [
      ...
      },
      {
        ...
        toolSteps: [
          {
            id: "today-step-1",
            title: "Plan input sources",
            status: "done",
            tool: "Plan",
            observation: "Selected Today, Notes, and Journal as sources for this turn.",
          },
          {
            id: "today-step-2",
            title: "Load today's entries",
            status: "done",
            tool: "local_memory.search",
            observation: "Found 5 todos, 3 snippets, and 1 journal draft.",
          },
          {
            id: "today-step-3",
            title: "Generate memory summary",
            status: "done",
            tool: "curator.compose",
            observation: "Focused the thread on renderer stability, note archiving, and next-step verification.",
          },
        ],
        ...
        toolSteps: [
          {
            ...
            observation: "The draft contains 4 themes, and 2 themes are missing next actions.",
          },
          {
            id: "weekly-step-2",
            ...
            observation: "Generated 3 tasks for tomorrow, each startable within 30 minutes.",
          },
        ],
        ...
        toolSteps: [
          {
            ...
            status: "queued",
            tool: "people.scan",
            observation: "Waiting for the user to confirm the people scope for this scan.",
          },
        ],
      },
      {
