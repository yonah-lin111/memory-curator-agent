...
// 提示词 AI 消息右键菜单组件属性类型。
export type PromptAiMessageContextMenuProps = {
  // 菜单左上角横坐标。
  x: number
  // 菜单左上角纵坐标。
  y: number
...
/**
 * PromptAiMessageContextMenu - 负责单条提示词 AI 消息的右键操作菜单。
 */
export const PromptAiMessageContextMenu = ({
  x,
  y,
  canRegenerate,
  onCopyText,
  ...
  onDeleteQa,
  onEdit,
}: PromptAiMessageContextMenuProps): React.JSX.Element => {
  // 是否已进入重新生成二次确认态。
