 ...
 * 根据完成状态与优先级生成标签样式。
 */
const getPriorityClassName = (priority: TodoPriority, completed: boolean): string => {
  if (completed) {
    ...
    <Tooltip
      form={
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-1 text-left">
            <span className="text-[11px] font-semibold text-white/40">todo状态</span>
            <RadioGroup
            ...
            >
              <Radio label={<span className="text-rose-300">删除</span>} value="yes" />
    ...
    <div className="rounded-[6px] border border-white/5 bg-[#212121] p-4 flex flex-col gap-3 h-[360px]">
      <div className="flex items-center justify-between border-b border-white/5 pb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-bold tracking-wide text-white/80">每日待办计划</span>
        </div>
        <div className="flex items-center gap-2">
          ...
          return (
            ...
            >
                  ...
                  <textarea
                    ...
                    onChange={(event) =>
                      setEditingTodo((currentDraft) =>
                        currentDraft ? { ...currentDraft, text: event.target.value } : currentDraft,
                      )
                    }
              ...
              <TodoActionMenu
                ...
                onMove={(nextEntryDate) => void onMoveTodo(todo.id, nextEntryDate)}
              />
            </div>
          )
        })}
