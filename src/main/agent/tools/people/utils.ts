 ...
 */
export const getPeopleMutationResultName = (result: { data: unknown }): string | null => {
...
export const renderPeopleMutationCompletion = (
  ...
  const target = getPeopleMutationResultName(result) ?? getPeopleInputString(input, "name")
