 ...
 * 判断值是否为 Ask 问题。
 */
const isAskQuestion = (value: unknown): value is CuratorAskQuestion =>
  isRecord(value) &&
 ...
 * 判断工具数据是否为 Ask 请求。
 */
export const isCuratorAskRequest = (value: unknown): value is CuratorAskRequest =>
  isRecord(value) &&
 ...
 * 判断工具数据是否为工具确认请求。
 */
export const isCuratorToolConfirmationRequest = (
  value: unknown,
): value is CuratorToolConfirmationRequest =>
  isRecord(value) &&
 ...
 * 判断工具数据是否为 Ask 回答。
 */
export const isCuratorAskAnswer = (value: unknown): value is CuratorAskAnswerData =>
  isRecord(value) &&
 ...
 */
export const CuratorAskRequestPanel = ({
  request,
  onSubmit,
