...
export const WeeklyReviewPage = (): React.JSX.Element => {
  ...
  return (
    <div
      ...
      className="w-full h-full bg-[#000000] overflow-y-auto custom-scrollbar p-4 flex flex-col gap-6 text-sm"
    >
      ...
      <div className="w-full flex flex-col bg-[#000000]">
        <div className="flex-shrink-0 mb-3 flex items-center justify-between border-b border-white/5 pb-2">
          ...
          <span className="text-xs font-mono text-white/30 uppercase tracking-[0.2em]">
            {getMonday(entryDate).replace(/-/g, "/")} -{" "}
            {getSunday(entryDate).replace(/-/g, "/")}
          </span>
        </div>
