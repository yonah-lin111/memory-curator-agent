 ...
 * 创建 Today 工具。
 */
export const createTodayTool = (
  context: AgentToolRegistryContext
): AgentTool => ({
  name: 'today_tool_summary',
  description: 'Query and summarize today\'s (or a specific date\'s) todos, snippets, journals, and bills in one go.',
  prompt: {
    summary: 'Query all records for a specific date (defaults to today) across todos, snippets, journals, and bills.',
    intentKeywords: [
      '今天',
      '今日',
      'today',
    ...
    whenNotToUse: [
      'Do not use to write data. This tool is read-only.'
    ],
    safety: [
      'Read only. Never modifies data.'
    ],
    output: 'Returns a comprehensive object containing todos, snippets, journal, and bills for the specified date.',
    examples: [
      '{}',
      '{"date":"2026-06-30"}'
    ]
