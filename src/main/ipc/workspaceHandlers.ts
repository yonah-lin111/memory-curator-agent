...
export const registerWorkspaceHandlers = (): void => {
  ...
  ipcMain.handle('workspace:todo:update', (_, id: number, input: WorkspaceTodoUpdateInput) =>
    workspaceService.updateTodo(id, input)
  )
  ipcMain.handle('workspace:todo:delete', (_, id: number) => {
  ...
  ipcMain.handle('workspace:snippet:update', (_, id: number, input: WorkspaceSnippetUpdateInput) =>
    workspaceService.updateSnippet(id, input)
  )
  ipcMain.handle('workspace:snippet:delete', (_, id: number) => {
