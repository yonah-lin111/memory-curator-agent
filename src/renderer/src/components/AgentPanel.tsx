...
const RELATED_MEMORIES: RelatedMemoryClue[] = [
  {
    ...
    date: "2026-03-12",
    resonance: "今日提到的本地文件存取性能与三月份多维检索承载模型存在架构设计承接。",
    similarity: 88
  },
  {
    id: 'rm2',
    ...
    date: "2025-11-20",
    resonance: "小雨天气及独立写布局的感受，与去年深夜重构时的情绪轨迹存在可复核关联线索。",
    similarity: 74
  }
]
              ...
              const TypeIcon =
                cl.suggestedType === 'todo'
                  ...
                  : cl.suggestedType === 'journal'
                    ...
                    : FileText
              const TypeLabel =
                cl.suggestedType === 'todo' ? '待办' : cl.suggestedType === 'journal' ? '日记' : '随记'
        ...
        <div className="rounded-[6px] border border-white/5 bg-[#212121] p-4 flex flex-col gap-3 flex-shrink-0">
          ...
          <div className="flex flex-col gap-2.5">
            {RELATED_MEMORIES.map((m) => (
              <div key={m.id} className="flex flex-col gap-1 rounded-[6px] bg-white/[0.01] border border-white/5 p-2.5">
        ...
        <div className="rounded-[6px] border border-white/5 bg-[#212121] p-4 flex flex-col gap-3 flex-shrink-0">
          ...
          <div className="flex flex-col gap-2">
            {THEME_CLUES.map((theme) => {
              ...
              return (
                <div key={theme.id} className="flex flex-col gap-1.5 rounded-[6px] bg-white/[0.01] border border-white/5 p-2.5">
                  <div className="flex items-center justify-between gap-2">
