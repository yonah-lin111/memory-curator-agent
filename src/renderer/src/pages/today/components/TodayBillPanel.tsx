...
import { BillEntryModal, type BillDraft } from "@/pages/bills/components/BillEntryModal";
 ...
 * 包含今日账单收支统计、最新账单明细、右上角轻量气泡录入，以及列表项快捷弹窗编辑。
 */
export const TodayBillPanel = (): React.JSX.Element => {
  ...
  const handleEditSave = async (billDraft: BillDraft): Promise<boolean> => {
